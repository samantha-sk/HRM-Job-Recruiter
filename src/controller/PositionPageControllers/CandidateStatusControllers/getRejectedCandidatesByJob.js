...
// GET /rejected/:jobId - Get rejected candidates for a specific job
export const getRejectedCandidatesByJob = async (req, res) => {
  try {
...
export default getRejectedCandidatesByJob;
